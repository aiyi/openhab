...
import org.openhab.core.transform.TransformModule;
...
public class XsltTransformationService implements TransformationService {
	...
	public String transform(String filename, String source) throws TransformationException {
		...
		try {
			String path = ConfigManager.getConfigFolder() + File.separator + TransformModule.TRANSFORM_FOLDER_NAME + File.separator + filename;
