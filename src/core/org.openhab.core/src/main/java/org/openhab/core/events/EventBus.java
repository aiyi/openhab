...
/**
 * EventBus is used to send commands or status updates and subscribe event to/from the event bus.
 * 
 * @author Jesse
 * @since 2.0.0
 */
public interface EventBus {
	...
	/**
	 * Register with the EventBus service of notification in order to receive state update and command.
	 * 
	 * @param subscriber listener for events
	 */
	public abstract void addSubscriber(EventSubscriber subscriber);
