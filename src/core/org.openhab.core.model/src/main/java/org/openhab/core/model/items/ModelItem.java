 ...
 *         &lt;element name="binding" type="{}ModelBinding" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlSeeAlso({
    ModelGroupItem.class,
    ModelNormalItem.class
})
public class ModelItem {
    ...
    protected List<ModelBinding> bindings;
    ...
    public List<ModelBinding> getBindings() {
        if (bindings == null) {
            bindings = new ArrayList<ModelBinding>();
        }
