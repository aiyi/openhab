...
import org.openhab.io.rest.internal.util.MediaTypeHelper;
import org.openhab.io.rest.internal.util.ResponseTypeHelper;
import org.openhab.core.model.ModelRepository;
import org.openhab.core.model.sitemap.Chart;
import org.openhab.core.model.sitemap.Frame;
import org.openhab.core.model.sitemap.Image;
import org.openhab.core.model.sitemap.LinkableWidget;
import org.openhab.core.model.sitemap.List;
import org.openhab.core.model.sitemap.Mapping;
import org.openhab.core.model.sitemap.Selection;
import org.openhab.core.model.sitemap.Setpoint;
import org.openhab.core.model.sitemap.Sitemap;
import org.openhab.core.model.sitemap.Slider;
import org.openhab.core.model.sitemap.Switch;
import org.openhab.core.model.sitemap.Video;
import org.openhab.core.model.sitemap.Webview;
...
public class SitemapResource {
		...
		if(sitemap!=null) {
			if(pageId.equals(sitemap.getName())) {
				...
				if(pageWidget instanceof LinkableWidget) {
					...
					Object parentPage = pageWidget.getParent();
					while(parentPage instanceof Frame) {
						parentPage = ((Frame)parentPage).getParent();
					}
	...
	public Collection<SitemapBean> getSitemapBeans(URI uri) {
		...
		for(String modelName : modelRepository.getAllModelNamesOfType("sitemap")) {
			...
			if(sitemap!=null) {
				...
				bean.name = modelName.substring(0, modelName.lastIndexOf(SITEMAP_FILEEXT));
    ...
    static private PageBean createPageBean(String sitemapName, String title, String icon, String pageId, java.util.List<Widget> children, boolean drillDown, URI uri) {
	...
	static private WidgetBean createWidgetBean(String sitemapName, Widget widget, boolean drillDown, URI uri, String widgetId) {
    	...
    	bean.type = widget.getClass().getSimpleName();
    	if (widget instanceof LinkableWidget) {
			LinkableWidget linkableWidget = (LinkableWidget) widget;
			java.util.List<Widget> children = itemUIRegistry.getChildren(linkableWidget);
    	...
    	if(widget instanceof Switch) {
    		...
    		for(Mapping mapping : switchWidget.getMappings()) {
    			...
    			mappingBean.command = mapping.getCommand();
